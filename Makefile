...
.install: .conda .channels
	export PATH=${PBASE}/conda/bin:${PATH} && conda install -y samtools bcftools bedtools htslib bwa trim-galore fastqc delly kraken2 ivar alfred seqtk freebayes mafft iqtree cyvcf2 && touch .install
