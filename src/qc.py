...
if qc ['RKI'] == "pass":
    if qc['Lineage'] == "B.1.1.7":
        ...
        qc['Type'] = "B.1.1.529"
    elif qc['Lineage'].startswith(("BA.", "BR.", "CA.", "CH.", "CJ.", "DA.", "DL.", "DJ.", "DG.", "BE.", "BF.", "BG.", "BH.", "BK.", "BL.", "BM.", "BN.", "BQ.", "BS.", "BT.", "BU.", "BY.", "BV.", "BW.", "CE.", "CB.", "CC.", "CK.", "CL.", "CN.", "CP.", "CR.", "CM.", "DN.", "DQ.", "BZ.", "DS.", "DU.", "DV.", "EA.", "EF.", "EY.", "FL.", "FU.", "GB.", "XBB", "XBK", "EG.","EN.","EU.")):
        qc['Type'] = "B.1.1.529"
